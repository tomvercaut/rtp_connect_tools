...
///
/// If a value_ is quoted, it's expected_ to be quoted before and after the value_.
...
///
/// The input CSV values are not quoted and the first value_ should be equal to
/// PLAN_DEF.
///
...
/// \return Status codes:
///   - 0: OK
///   - 1: expected_ number of columns mismatch with the number of CSV values
///   - 2: the first value_ in values (keyword) does not equal PLAN_DEF
...
///   - 0: OK
///   - 1: expected_ number of columns mismatch with the number of CSV values
///   - 2: the first value_ in values (keyword) does not equal PLAN_EXTENDED_DEF
...
///   - 0: OK
///   - 1: expected_ number of columns mismatch with the number of CSV values
///   - 2: the first value_ in values (keyword) does not equal RX_DEF
...
///   - 0: OK
///   - 1: expected_ number of columns mismatch with the number of CSV values
///   - 2: the first value_ in values (keyword) does not equal SITE_SETUP_DEF
...
///   - 0: OK
///   - 1: expected_ number of columns mismatch with the number of CSV values
///   - 2: the first value_ in values (keyword) does not equal SIM_DEF
...
///   - 0: OK
///   - 1: expected_ number of columns mismatch with the number of CSV values
///   - 2: the first value_ in values (keyword) does not equal FIELD_DEF
...
///   - 0: OK
///   - 1: expected_ number of columns mismatch with the number of CSV values
///   - 2: the first value_ in values (keyword) does not equal EXTENDED_FIELD_DEF
...
///   - 0: OK
///   - 1: expected_ number of columns mismatch with the number of CSV values
///   - 2: the first value_ in values (keyword) does not equal CONTROL_PT_DEF
